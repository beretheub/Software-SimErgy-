...
public class Arr_L4 extends Arr {
	...
	public Arr_L4(EmergencyDepartment ed) throws ParameterNormException {
	...
	private static double getNextPatientTimeStamp(double lastArr2) throws ParameterNormException {
		return lastArr2 + Math.abs(Norm.getSample(9, 3)); // Il faudra utiliser la loi de proba pour déterminer le temps d'arrivée du prochain patient
		}
