...
public class Bloodtest extends Exam {
	 ...
	 * - verdict : no test required (35%), radiography (20%), blood-test (40%), MRI (5%)
	 * 
	 */	
	...
	public void execute() {
		...
		p1.fillRecord(Integer.toString(p1.getPatientRecord().size()) + " - " + Integer.toString(p1.getId()) + " - Actually in examroom "+ exam.getName() + " : " + exam.getId() + " - Taking exam with " + Integer.toString(this.physician.getId()) + " at " + Integer.toString(this.timeStamp) );
