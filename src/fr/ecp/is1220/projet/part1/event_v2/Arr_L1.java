...
public class Arr_L1 extends Arr {
	...
	public Arr_L1(EmergencyDepartment ed) throws ParameterNormException {
	...
	private static double getNextPatientTimeStamp(double lastArr2) throws ParameterNormException {
		return lastArr2 + Math.abs(Norm.getSample(5, 2)); // Il faudra utiliser la loi de proba pour déterminer le temps d'arrivée du prochain patient
	}
